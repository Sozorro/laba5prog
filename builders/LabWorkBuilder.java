...
public class LabWorkBuilder extends Builder {
    ...
    public Coordinates makeCoordinates(String... args) throws WrongParam, WrongAction {
        ...
        Function<String, String[]> fgetPar = (mess) -> {
            String[] param;
            String[] str = Input.getParams(mess).split(" ");
            String[] str2 = null;
            if(str.length == 1) {
                str2 = Input.getParams("Теперь введите у:").split(" ");
            }
            param = new String[1 + str2.length]; 
            param[0] = str[0];
