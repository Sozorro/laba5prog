...
public class FilterStartsWithDescriptionCom extends Command {
    ...
    public void execute(String... args) {
        try {
            String str;
            if(args == null && InputFile.readFile == false) str = Input.getParams("Введите подстроку: ");
            else if (args == null) throw new WrongParam("\tВведены не все параметры или они некорректно заданы, хотите ввести их ещё раз в интерактивном режиме? \n");
